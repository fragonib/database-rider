...
class SpringBootDataJpaRollbackTest {
    ...
    @ExpectedDataSet(value = "expectedUsersWhenInsideSpringTX.yml", orderBy = "id")
    void dbRiderTest_thatShouldHaveBeenCleaned_dueToSpringRolledBackTX() {
